...
To gain a deeper understanding of the database structure, we recommend exploring the model documentation available in GitHub. You can find this under [`/neo4j-mdr-db/model`](https://github.com/NovoNordisk-OpenSource/openstudybuilder-solution/tree/main/neo4j-mdr-db/model){target=_blank}. This resource provides a detailed overview of the database model, helping you to understand how the data is organized and interconnected.
